...
/**
 * The brand lockup: the `{ 塔 }` mark set flush against the lowercase "syokan" wordmark in
 * Cormorant — a sharp, high-contrast display serif that offsets the mark's bold geometry. The
  ...
  return (
    ...
    >
      ...
      >
        <path d={BRACE_LEFT} />
        <path d={BRACE_RIGHT} />
        <path d={TOWER} fill="currentColor" fillRule="evenodd" stroke="none" />
      </svg>
